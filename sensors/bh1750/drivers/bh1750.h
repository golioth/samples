...
#define BH1750_SAMPLES_TO_FETCH                 5

struct bh1750_data {
	const struct device *i2c;
	const struct device *dev;
	uint16_t sample_amb_light[BH1750_SAMPLES_TO_FETCH];
...
// static int readLightLevel(const struct device *dev, enum sensor_channel chan);
